...
int main(int argc, char* argv[]){
    ...
    fstream cluster_file;           //CLUSTER CONFIGURATION FILE
    fstream output_file;            //FILE TO WRITE OUTPUT TO
    int point_id;
    string line;
    string input_file_name, query_file_name, cluster_file_name, output_file_name;
    int start;
    int finish = 0;
    ...
    while(continue_execution == 1){
        ...
        if(strcmp(argv[0], "./lsh") == 0 || strcmp(argv[0], "./cube") == 0){
            ...
            open_file(&cluster_file, argv[3], fstream::in);
